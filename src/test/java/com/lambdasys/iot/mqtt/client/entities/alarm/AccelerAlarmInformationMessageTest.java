...
public class AccelerAlarmInformationMessageTest implements Serializable {
	...
	@BeforeSuite(description="Inicializando recursos para teste de AccelerAlarmInformationMessage...")
	public void setUp() {
		this.message = AlarmInformationMessage.builder().build();;
	}
	
	@AfterSuite(description="Finalizando recursos para teste de AccelerAlarmInformationMessage...")
	...
	public Object[][] dataProviderObject(){
		return new Object[][] {
			{  AlarmMessagePayload.builder()
					...
					.data( AccelerAlarmDataMessagePayload.builder()

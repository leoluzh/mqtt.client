...
public class MoveCollisionAlarmInformationMessageTest implements Serializable {

	protected AlarmInformationMessage message;

	@BeforeSuite(description="Inicializando recursos para teste de MoveCollisionAlarmInformationMessage...")
	public void setUp() {
		this.message = AlarmInformationMessage.builder().build();;
	}
	
	@AfterSuite(description="Finalizando recursos para teste de MoveCollisionAlarmInformationMessage...")
	...
	public Object[][] dataProviderJson(){
		return new Object[][] {
			{ "{ \"type\": \"moveCollision\", \"eventTime\": \"2017-05-03T08:57:11Z\" , \"data\": { \"gensorValue\": 101.22 , \"lat\" : 114.05540500000001 , \"lon\" : 22.66381333333333 , \"trip_sn\" : 12345} }" 	},
		};
	}
	...
	public Object[][] dataProviderObject(){
		return new Object[][] {
			{  AlarmMessagePayload.builder()
					...
					.data( MoveCollisionAlarmDataMessagePayload.builder()
								.gensorValue(101.22)
